...
Let's fix it. When it comes to overlapping labels, *ggrepel* package is second to none. With the magic of one simple geom_text_repel() function we're able to improve visibility drastically.
